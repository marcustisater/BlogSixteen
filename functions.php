...
function blogsixteen_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'blogsixteen_custom_background_args', array(
...
function blogsixteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Sidebar 1', 'blogsixteen' ),
		'id'            => 'sidebar-footer-1',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Sidebar 2', 'blogsixteen' ),
		'id'            => 'sidebar-footer-2',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
